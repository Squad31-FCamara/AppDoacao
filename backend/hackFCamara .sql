...
--
-- Host: localhost:3306
-- Tempo de geração: 31/03/2021 às 15:23
...
INSERT INTO `donatario` (`id_donatario`, `ra_donatario`, `nome_donatario`, `avatar`, `email_responsavel`, `telefone_responsavel`, `cep`, `logradouro`, `complemento`, `bairro`, `cidade`, `uf`, `escola_donatario`, `segmento_ensino`, `serie_ensino`, `tipo_doacao`, `sonho_profissao`, `data_cadastro`) VALUES
(1, NULL, NULL, 'avatar1.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental I', '4°', 'material_escolar', '“Moro com meus pais e meu irmão de 3 anos. Adoro jogar bola, mas sonho em ser um astronauta da Nasa.”', '2021-03-31 14:24:03'),
(2, NULL, NULL, 'avatar2.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental I', '5°', 'material_escolar', '“Moro com meus pais e meus dois irmãos. Meu sonho é ser um cientista e encontrar a cura para muitas doenças.”', '2021-03-31 14:24:03'),
(3, NULL, NULL, 'avatar3.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental I', '3°', 'material_escolar', '“Sou filha única e moro com a minha mãe. Ela trabalha muito para me criar sozinha. Meu sonho é ser médica.”', '2021-03-31 14:24:03'),
(4, NULL, NULL, 'avatar3.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental II', '6°', 'uniforme', '“Moro com meus avós e sou muito curiosa, Quando eu crescer quero ser professora de ciências.”', '2021-03-31 14:24:03'),
(5, NULL, NULL, 'avatar1.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental I', '2°', 'eletronico', '“Moro com meus pais e meu irmão. Meu sonho é ser chefe de cozinha igual ao Fogaça do Masterchef.”', '2021-03-31 14:24:03'),
(6, NULL, NULL, 'avatar2.png', NULL, NULL, NULL, NULL, NULL, NULL, 'Paty do Alferes', 'RJ', 1, 'Ensino Fundamental II', '9°', 'eletronico', '“Moro com a minha mãe e a minha avó. Quando eu crescer quero ser piloto de avião para poder viajar o mundo todo.”', '2021-03-31 14:24:03');
...
INSERT INTO `kit` (`id_kit`, `nome`, `elementos`) VALUES
(1, 'Kit 1', '1 estojo, 5 lápis pretos, 2 borrachas, 2 apontadores, 1 cola bastão'),
...
--
-- Estrutura para tabela `relacao_kit_donatario`
--

CREATE TABLE `relacao_kit_donatario` (
  `id` int NOT NULL,
...
--
-- Despejando dados para a tabela `relacao_kit_donatario`
--

INSERT INTO `relacao_kit_donatario` (`id`, `id_donatario`, `id_kit`, `status_item`) VALUES
(1, 1, 1, 'Pendente'),
(2, 1, 2, 'Pendente');
...
--
-- Índices de tabela `relacao_kit_donatario`
--
ALTER TABLE `relacao_kit_donatario`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de tabela `relacao_kit_donatario`
--
ALTER TABLE `relacao_kit_donatario`
...
--
-- Restrições para tabelas `relacao_kit_donatario`
--
ALTER TABLE `relacao_kit_donatario`
  ADD CONSTRAINT `relacao_kit_donatario_ibfk_1` FOREIGN KEY (`id_donatario`) REFERENCES `donatario` (`id_donatario`),
  ADD CONSTRAINT `relacao_kit_donatario_ibfk_2` FOREIGN KEY (`id_kit`) REFERENCES `kit` (`id_kit`);
COMMIT;
